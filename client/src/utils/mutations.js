...
export const ADD_TASK = gql`
  mutation addTask($tripId: ID!, $title: String!, $details: String, $dueDate: String!, $status: Boolean!, $assignee: String!) {
    addTask(tripId: $tripId, title: $title, details: $details, dueDate: $dueDate, status: $status, assignee: $assignee) {
      title
      details
      dueDate
      status
...
export const ADD_BUDGET = gql`
  mutation addBudget($tripId: ID!, $title: String!, $value: Int!, $purchaseDate: String!, $purchasedBy: String!) {
    addBudget(tripId: $tripId, title: $title, purcahseDate: $purchaseDate, purchasedBy: $purchasedBy)
    {
      title
      value
      purchaseDate
...
export const UPDATE_TASK = gql`
  mutation updateTask($tripId: ID!, $taskId:ID!, $title: String!, $details: String, $dueDate: String!, $status: Boolean!, $assignee: String!
  ) {
    updateTask(tripId: $tripId, taskId:$taskId, title: $title, details: $details, dueDate: $dueDate, status: $status, assignee: $assignee) {
      title
      details
      dueDate
      status
...
export const UPDATE_BUDGET = gql`
  mutation updateBudget($tripId: ID!, $budgetId: ID!, $title: String!, $value: Int!$purchaseDate: String!, $purchasedBy: String!) {
    addBudget(tripId: $tripId, budgetId: $budgetId, title: $title, purchaseDate:$purchaseDate, purchasedBy: $purchasedBy) {
      title
      value
      purchaseDate
      purchasedBy
